...
<body>
	<div class="header">
		<div class="container">
			<div class="left">
				<img src="/Public/Home/image/Register/logo_h.png" class="left_img_1">
			...
			<div class="right">
				...
				<div class="divider"></div>
				<a href="/index.php/Home/Index/index">MY OPPO</a>
			</div>
		</div>
	</div>
	<div class="body_1">
		<div class="container">
			<div class="body_1_header">
				...
				<a href="/index.php/Home/Login/index">点此登录</a>
				<span id="body_1_header_for_normal">)</span>
			</div>
			<form method="post" action="/index.php/Home/Register/insert">
				<div class="body_1_form_1">
					...
					<img id="form_1_info_1_img" src="/Public/Home/image/Register/ex.png">
				...
				<div class="body_1_form_2">
					...
					<img id="form_1_info_2_img" src="/Public/Home/image/Register/ex.png">
				...
				<div class="body_1_form_3">
					...
					<img id="form_1_info_3_img" src="/Public/Home/image/Register/ex.png">
				...
				<div class="body_1_form_4">
					...
					<img src="/index.php/Home/Register/VerifyCode" id="body_1_form_4_img">
					<img src="/Public/Home/image/Register/shuaxin.png" id="body_1_form_4_change">
					<img src="/Public/Home/image/Register/ex.png" id="body_1_form_4_info_img">
					<span id="body_1_form_4_info_1">请输入验证码</span>
					<span id="body_1_form_4_info_2">验证码错误</span>
				</div>
				<div class="body_1_form_5">
					<img src="/Public/Home/image/Register/checkboxX.png" id="body_1_form_5_image" status="0">
					<span>我已阅读并同意</span>
					<a href="#">《OPPO服务协议》</a>
					<img id="body_1_form_5_info_img" src="/Public/Home/image/Register/ex.png">
...
<script type="text/javascript" src="/Public/Home/js/Register/index.js"></script>
</html>